...
switch (process.env.NODE_ENV) {
    case 'development':// start 命令
        ...
        switch (process.env.REACT_APP_ENV) {
            ...
            case 'production':
                ...
                break
            default:
                throw new Error(`请正确设置 REACT_APP_ENV，目前未配置 test 环境。当前的 REACT_APP_ENV = ${process.env.REACT_APP_ENV}, NODE_ENV = ${process.env.NODE_ENV}`)
        }
    ...
    default:
        throw new Error(`请正确设置 NODE_ENV，目前未配置 test 环境。当前的 REACT_APP_ENV = ${process.env.REACT_APP_ENV}, NODE_ENV = ${process.env.NODE_ENV}`)
}
